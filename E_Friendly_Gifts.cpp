...
int main()
{
    ...
    while (t--)
    {
        ...
        vector<vector<int>> allsf(maxK + 2, vector<int>(n + 2, -1));
        vector<vector<int>> allsl(maxK + 2, vector<int>(n + 2, -1));
        ...
        for (ll i = 0; i < n; i++)
        {
            ...
            for (ll j = i; j < n; j++)
            {
                ...
                if (mxm - minm + 1 == j - i + 1 && sz <= maxK)
                {
                    if (allsf[sz][minm] == -1)
                        allsf[sz][minm] = i, allsl[sz][minm] = i;
                    else
                        allsl[sz][minm] = i;
                }
            }
